...
export default function PartnerMarquee() {
  ...
  return (
    ...
    >
      <div className="relative" role="region" aria-label="Carrossel de parceiros">
        <div
          className="absolute left-0 top-0 bottom-0 z-10 w-7.5 md:w-37.5 pointer-events-none"
          style={{ background: "linear-gradient(to right, rgb(255 255 255 / 0.25) , transparent)" }}
          aria-hidden="true"
        />

        <div
          className="absolute right-0 top-0 bottom-0 z-10 w-7.5 md:w-37.5 pointer-events-none"
          style={{ background: "linear-gradient(to left, rgb(255 255 255 / 0.25), transparent)" }}
          aria-hidden="true"
        />
