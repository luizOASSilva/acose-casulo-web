    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto flex items-center justify-between px-4 lg:px-6 h-20">
          ...
          <Link href="/" className="flex shrink-0" onClick={closeMenus} aria-label="Ir para a página inicial da Acose Casulo">
            <Image src="/logo.svg" alt="Acose Casulo" width={100} height={100} priority />
          </Link>
          ...
          >
            <ul className="flex flex-col lg:flex-row lg:gap-8 lg:items-center lg:p-0 w-full lg:w-auto" role="list">
              ...
              >
                <button
                  ...
                  aria-label={dropdownOpen ? "Fechar submenu de artigos" : "Abrir submenu de artigos"}
                  className={cn(
