    ...
    <footer className="bg-footer text-sm" aria-label="Rodapé do site">
      <div className="max-w-7xl mx-auto px-4 lg:px-6 py-16 grid grid-cols-1 md:grid-cols-3 md:items-start md:justify-items-center gap-10">
        <div className="max-w-xs flex flex-col gap-3 text-left">
          ...
          <p className="text-gray-600">ONG • Bragança Paulista/SP</p>
        ...
        <div className="max-w-xs flex flex-col gap-3 text-left">
          <h2 className="font-semibold text-base">Horário de atendimento</h2>
        ...
        <div className="max-w-xs flex flex-col gap-3 text-left">
          <h2 className="font-semibold text-base">Fale conosco</h2>
          ...
          <address className="flex flex-col gap-1 not-italic text-gray-600">
            ...
            <a
              ...
              className="text-primary hover:underline transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary mt-1"
