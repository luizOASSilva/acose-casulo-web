...
export default async function EsqueciSenha({ params }: Props) {
  ...
  return (
    <main className="min-h-screen">
      <section
        ...
        aria-label="Recuperação de acesso da plataforma"
      >
          ...
          <div className="relative z-10 w-full max-w-sm">
            <header className="mb-8 space-y-2">
              ...
              <p className="text-sm leading-relaxed text-gray-500">
                Informe seu e-mail de acesso. Se ele estiver cadastrado,
